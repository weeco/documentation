...
Refer to the leftmost navigation menu as "navigation menu" rather than the general term "interface". You can direct users to submenu items with the caret symbol (>). For example, "From the navigation menu, select Deployment > Starting a local cluster".
...
| please                                 | Do not use this term. In some languages and cultures, it suggests the task or directive is optional.                 |
| should                                 | will, must                                                                    |
