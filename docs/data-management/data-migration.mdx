...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](/docs/quickstart/quick-start-kubernetes), [Docker](/docs/quickstart/quick-start-docker), [Linux](/docs/quickstart/quick-start-linux), or [MacOS](/docs/quickstart/quick-start-macos).
