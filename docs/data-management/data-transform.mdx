...
This feature is in technical preview and is not supported for production. For instructions on how to install features that are in technical preview, see the [Installing beta versions](/docs/deployment/install-preview) documentation.

We recommend that you do not use Data Transforms with Tiered Storage. There is a high likelihood that you will encounter problems if you use Data Transforms and Tiered Storage on a topic.
