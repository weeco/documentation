...
:::caution
Do not use Tiered Storage with [data transforms](https://docs.redpanda.com/docs/data-management/data-transform), which is in technical preview. Technical preview features are not supported for production usage.
:::
