...
<head>
    ...
    <meta name="description" content="Configuring tiered storage feature."/>
</head>
...
It is recommended that you do not use Tiered Storage with <a href="https://docs.redpanda.com/docs/data-management/data-transform/" target="_self">Data Transforms</a>, which is in technical preview. If you do, there is a likelihood that you will encounter problems with topics.
