...
We recommend that you do not use Tiered Storage with <a href="https://docs.redpanda.com/docs/data-management/data-transform/" target="_self">Data Transforms</a>, which is in technical preview. There is a high likelihood that you will encounter problems if you use Data Transforms and Tiered Storage on a topic.
