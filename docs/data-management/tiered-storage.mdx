...
:::important
This feature requires an [Enterprise license](/docs/core/introduction/licensing). To upgrade, contact [Redpanda sales](https://redpanda.com/try-redpanda?section=enterprise-cloud).
:::
