...
As part of agent deployment, Redpanda assigns the permissions required to run the
agent. For details about these permissions, see [GCP IAM Policies](../security/cloud-security-architecture/authorization/cloud-authorization#gcp-iam-policies).
