...
You can use the Kafka Connect BigQuery Sink connector to export data from Apache® Kafka
topics to Google BigQuery.

## Prerequisites

Before you can create a BigQuery sink connector in the Redpanda Cloud, you must have:

  * A namespace and cluster provisioned in Redpanda Cloud
  * Login credentials to BigQuery
