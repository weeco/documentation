...
2. Select the (Export to) S3 Sink managed connector.
...
* [S3 Sink Connector for Apache Kafka](https://github.com/redpanda-data/connectors/blob/main/s3-sink-connector/README.md)
