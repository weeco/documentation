...
2. In the **GCP home** page:
   ...
   3. (_Optional_) After creating the dataset, [create a new table](https://cloud.google.com/bigquery/docs/tables) to hold the data you intend to stream from Redpanda Cloud topics.
...
The GCP BigQuery Sink connector has the following limitation:
...
2. Select the  BigQuery Sink connector, and click **Next**.
...
### Advanced GCP BigQuery Sink connector configuration
