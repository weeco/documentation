...
* Before you can create a GCS Sink connector in the Redpanda Cloud, You must have:

  * A cluster provisioned in Redpanda Cloud.
  * Login credentials to GCS.
...
**^^ These properties are not described in our docs, and are not included in the properties tables below. We should provide the descriptions somewhwere.**

* For production deployments, you must use [Java 17 or later](https://www.oracle.com/java/technologies/downloads/).
...
1. From the navigation menu of Redpanda Cloud, select your select your namespace,
   and then your cluster to access the Redpanda Console.
