...
agent. For details about these permissions, see [AWS IAM Policies](../security/cloud-security-architecture/authorization/cloud-authorization#aws-iam-policies).
