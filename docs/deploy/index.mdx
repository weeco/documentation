...
- [Choose a Deployment Option](../deploy/deployment-option)
  - [Self-Hosted](../deploy/deployment-option/self-hosted)
    - [Kubernetes](../deploy/deployment-option/self-hosted/kubernetes)
      - [Kubernetes Cluster Requirements](../deploy/deployment-option/self-hosted/kubernetes/kubernetes-cluster-requirements)
      ...
      - [Kubernetes Production Deployment](../deploy/deployment-option/self-hosted/kubernetes/kubernetes-production-deployment)
      ...
      - [Best Practices](../deploy/deployment-option/self-hosted/kubernetes/kubernetes-best-practices)

          This topic explains Redpanda's tips and recommendations for Kubernetes deployments.

      - [Tune Worker Nodes](../deploy/deployment-option/self-hosted/kubernetes/kubernetes-tune-workers)
      ...
      - [Deploy Redpanda](../deploy/deployment-option/self-hosted/kubernetes/kubernetes-deploy)
