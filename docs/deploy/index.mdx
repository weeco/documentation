...
<head>
  ...
  - [Cloud](../deploy/deployment-option/cloud)
    - [Redpanda Cloud Overview](../deploy/deployment-option/cloud/cloud-architecture)
    ...
    - Security
      - [Redpanda Cloud Security Overview](../deploy/deployment-option/cloud/security/security-overview)
