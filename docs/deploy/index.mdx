...
<head>
  ...
  - [Cloud](../deploy/deployment-option/cloud)
    - [Redpanda Cloud Overview](../deploy/deployment-option/cloud/cloud-overview)
    ...
    - Security
      - [Redpanda Cloud Security Overview](../deploy/deployment-option/cloud/security/cloud-security-architecture)
