...
<head>
    ...
    <meta name="description" content="Enabling performance and storage tuning."/>
</head>
...
For details about how to modify cluster configuration properties, refer to [Cluster configuration](/docs/cluster-administration/cluster-property-configuration). 
