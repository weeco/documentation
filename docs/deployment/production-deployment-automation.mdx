...
You can easily deploy Redpanda for production on [bare-metal with the Redpanda installation binary](/docs/deployment/production-deployment).
...
- With the [Redpanda installation binary](/docs/deployment/production-deployment)
- With Ansible

## Installing Redpanda with Ansible

Whether you are using [bare-metal servers](/docs/deployment/production-deployment) or Terraform, you can use Ansible to install Redpanda.
