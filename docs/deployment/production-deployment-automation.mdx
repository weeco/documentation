...
You can deploy Redpanda for production on [bare metal with the Redpanda installation binary](/docs/deployment/production-deployment).
...
Now you can install Redpanda either with the [Redpanda installation binary](/docs/deployment/production-deployment) or with Ansible.
