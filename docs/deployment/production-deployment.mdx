...
To try out Redpanda, see the [60-Second Guides](../../quickstart).

:::note
Before you set up your Redpanda cluster, see [Managing Disk Space](../../deployment/disk-utilization) for guidelines on cluster creation.
:::
