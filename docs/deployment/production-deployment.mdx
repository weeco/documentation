...
[Docker](/docs/quickstart/quick-start-docker), or [Kubernetes](/docs/quickstart/quick-start-kubernetes).

:::note
Before you set up your Redpanda cluster, refer to the [Performance and storage tuning](https://docs.redpanda.com/docs/deployment/performance-storage-tuning) documentation for guidelines on cluster creation, such as avoiding out-of-disk outages.
:::
