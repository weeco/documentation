...
[60-Second Kubernetes for Cloud](/docs/quickstart/kubernetes-qs-cloud/) describes how to quickly get up and running with a Kubernetes cluster.
Those instructions provide access to the cluster from within the Kubernetes network.

This section shows how to set up Kubernetes in
...
- For a detailed explanation, see [Configuring the Kubernetes Operator for Connectivity](/docs/deployment/kubernetes-connectivity).
