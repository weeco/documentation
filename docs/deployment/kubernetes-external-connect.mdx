...
This section shows how to set up Kubernetes with the Redpand operator in
...
<Tabs>
  ...
  Complete the "Before You Begin" steps described in [Google Kubernetes Engine Quickstart](https://cloud.google.com/kubernetes-engine../../quickstart).
...
- For a detailed explanation, see [Configuring the Kubernetes Operator for Connectivity](../../deployment/kubernetes-connectivity).
