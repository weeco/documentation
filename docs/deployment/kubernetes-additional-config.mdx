...
In addition to the basic cluster specifications, you can add other parameters that are typically defined in the Redpanda [configuration file](/docs/cluster-management/configuration).
