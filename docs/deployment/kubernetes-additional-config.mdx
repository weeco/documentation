...
:::tip
Follow one of the Redpanda Kubernetes 60-second guides to install the Redpanda operator and create a cluster. See [cloud](/docs/quickstart/kubernetes-qs-cloud/), [kind](/docs/quickstart/kubernetes-qs-local-access), and [minikube](/docs/quickstart/kubernetes-qs-minikube).
:::
...
To see whether a change to a property requires a restart, see [Cluster-level properties](/docs/reference/cluster-properties).
