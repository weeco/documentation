...
Cluster. However, Redpanda offers a broad range of parameters ([Custom configuration](/docs/cluster-management/configuration)) not all of which are included in the Cluster definition.
