...
<head>
    <meta name="title" content="Using NodeJS with Redpanda | Redpanda Docs"/>
    <meta name="description" content="Implementing producer and consumer in NodeJS to work with Redpanda."/>
</head>
...
reach out to our team on our <a href="https://redpanda.com/slack" target="_self">slack</a>).
...
If you are on MacOS, check out [this post](/docs/quickstart/quick-start-macos).
If you're on linux, follow the instructions in the
[Quick start section](/docs/quickstart/quick-start-linux)
