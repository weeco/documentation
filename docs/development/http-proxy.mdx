...
<head>
    <meta name="title" content="Redpanda HTTP Proxy | Redpanda Docs"/>
...
The first step is to deploy Redpanda, which can be done in multiple ways. See the [60-Second Guides](https://docs.redpanda.com/docs/quickstart/) for more information.
...
For more information, see [rpk Commands](/docs/reference/rpk/rpk-topic/rpk-topic-create).
...
:::note
This assumes you're in the root directory of an existing NodeJS project. See [Using NodeJS with Redpanda](https://docs.redpanda.com/docs/features/guide-nodejs) for one way to get started with a new NodeJS project and examples of connecting to Redpanda with a native library. 
:::
