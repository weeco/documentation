---
title: Configure Remote Read Replicas in Kubernetes
tags:
  - Kubernetes
  - Helm configuration
...
<head>
    <meta name="title" content="Configure Remote Read Replicas in Kubernetes | Redpanda Docs"/>
