...
<Term popup="An instance of the Redpanda service, which includes the Kafka API, Schema Registry, the Admin API, and the HTTP proxy (PandaProxy)." reference="/docs/terms/broker">brokers</Term>
