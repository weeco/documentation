...
- For `/public_metrics` for example: 
...
In Grafana, import the generated JSON file to create a dashboard. The default dashboard shows information about available Redpanda nodes, partitions, latency, and throughput graphics.
