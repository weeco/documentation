...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](../../get-started/quick-start/kubernetes-qs-dev), [Docker](../../get-started/quick-start/quick-start-docker), [Linux](../../get-started/quick-start/quick-start-linux), or [macOS](../../get-started/quick-start/quick-start-macos).
