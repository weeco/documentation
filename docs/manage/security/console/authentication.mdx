...
Redpanda Console supports authentication through OAuth 2.0 and OIDC for external identity providers
as well as a plain login (username and password) for development environments or demo purposes.
The following options are supported:
- [Google](../google)
- [GitHub](../github)
- [Okta](../okta)
- [Generic OIDC](../generic-oidc)
- [Plain](../plain) (username and password)
