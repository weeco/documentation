...
login:
  ...
  # If you are not using SSL in your environment, it is necessary to 
...
:::note
Disable the `useSecureCookies` option as shown in the above code snippet if Console is exposed via HTTP instead of HTTPS.
:::
