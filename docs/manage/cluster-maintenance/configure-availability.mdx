...
- [`kafka_connections_max`](../../../reference/cluster-properties#kafka_connections_max): Similar to Kafka's `max.connections`, this sets the maximum number of connections created by a broker.
- [`kafka_connections_max_per_ip`](../../../reference/cluster-properties#kafka_connections_max_per_ip): Similar to Kafka's `max.connections.per.ip`, this sets the maximum number of connections created per IP address by a broker.
...
See also: [Configure Producers](../../../develop/produce-data/)
