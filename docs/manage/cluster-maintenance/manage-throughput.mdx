...
- [max_kafka_throttle_delay_ms](../../../reference/tunable-properties#max_kafka_throttle_delay_ms): when throttling down throughput for a shard, this is the maximum duration that the balancer withholds allocating quota to it.
