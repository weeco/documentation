---
title: Configure Cluster Properties in Linux
linkRoot: ../../../
deployment: Linux
contextLinks:
  - name: 'Linux'
...
<head>
    <meta name="title" content="Configure Cluster Properties in Linux | Redpanda Docs" data-rh="true"/>
...
## Remove cluster properties from a redpanda.yaml file
