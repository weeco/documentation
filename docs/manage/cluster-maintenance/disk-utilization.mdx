...
| ---               | ---                                                |  ---                                 |
| Time-based        | [delete_retention_ms](../../../reference/cluster-properties#delete_retention_ms) | [retention.ms](../../../reference/topic-properties#retentionms)    |
| Size-based        | [retention_bytes](../../../reference/cluster-properties#retention_bytes) | [retention.bytes](../../../reference/topic-properties#retentionbytes) |
| Segment size      | [log_segment_size](../../../reference/tunable-properties#log_segment_size) | [segment.bytes](../../../reference/topic-properties#segmentbytes)                                |
...
To configure log segment size on a topic, [`segment.bytes`](../../../reference/topic-properties#segmentbytes): 
...
Compaction, or key-based retention, saves space by retaining only the last known value for each message key within the segment. The latest value for each key is preserved, and all older values are discarded. 
