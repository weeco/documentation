...
You can have up to two listeners per API, but only one listener can have TLS enabled. You can specify which listener has TLS enabled in the cluster custom resource. 
