...
You can follow our [Getting Started guides](/docs/getting-started/) to learn how to get started with Redpanda.
...
If you're on Kubernetes, [we wrote a TLS guide exclusive for it](/docs/features/tls-kubernetes/).
