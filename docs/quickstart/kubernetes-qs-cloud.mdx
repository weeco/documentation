...
Use `rpk` to run commands. `rpk` is a CLI tool you can use to work with your Redpanda nodes. See [rpk Commands](/docs/reference/rpk/rpk-topic) Here are some sample commands to produce and consume streams:
