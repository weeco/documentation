---
title: 60-Second Guide for Docker
---

<head>
    <meta name="title" content="Docker Quick Start Guide | Redpanda Docs"/>
    <meta name="description" content="Docker quick start guide."/>
</head>

You can only run Redpanda directly on Linux. However, you can use Docker to run Redpanda on any system supported by Docker. This 60-Second Guide helps you get started with Redpanda for development and testing. 

For production or benchmarking, see [Deploying for Production](/docs/deployment/production-deployment).
...
:::note
You can also use [`rpk container`](/docs/deployment/guide-rpk-container) to run Redpanda in containers without having to interact with Docker at all.
:::
...
Otherwise, point your [Kafka-compatible client](/docs/reference/faq#what-clients-do-you-recommend-to-use-with-redpanda) to 127.0.0.1:9092.
