...
<head>
    <meta name="title" content="What's next? | Redpanda Docs"/>
    <meta name="description" content="Suggested topics for post-quick start guides."/>
</head>
...
Creating an application to interact with your Redpanda cluster using [NodeJS](/docs/development/guide-nodejs) is a good start for developers.
