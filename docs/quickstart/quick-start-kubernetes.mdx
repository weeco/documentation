...
You can find more information about the command as well as tuning recommendations in the <a href="https://redpanda.com/docs/production-deployment/#Step-2-Set-Redpanda-production-mode" target="_self">Set Redpanda production mode</a> documentation. 
