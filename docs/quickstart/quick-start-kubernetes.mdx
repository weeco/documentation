...
You can find more information about the command as well as tuning recommendations in the [Set Redpanda production mode](/docs/production-deployment/#Step-2-Set-Redpanda-production-mode) documentation. 
