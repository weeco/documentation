---
title: 60-Second Guide for macOS
---

<head>
    <meta name="title" content="MacOS Quick Start Guide | Redpanda Docs"/>
    <meta name="description" content="MacOS quick start guide."/>
</head>

You can only run Redpanda directly on Linux. However, you can run Redpanda on macOS in a Docker container. This 60-Second Guide helps you get started with Redpanda for development and testing.
...
To customize the containers, you can also set up your own [Redpanda containers in Docker](/docs/quickstart/quick-start-docker).
