...
When you enable rack awareness in the Helm chart, Kubernetes failure zones are treated as racks. Redpanda maps each rack to a failure zone and places partition replicas across them. For more information about what Redpanda rack awareness is and why it's used, see [data-management/rack-awareness](./rack-awareness). For more details about Kubernetes failure zones, see the [Kubernetes documentation](https://kubernetes.io/docs/setup/best-practices/multiple-zones/).
