...
After the node is in maintenance mode, perform a node upgrade by following the [version upgrade](../../install-upgrade/version-upgrade/) process specific to your deployment model.
