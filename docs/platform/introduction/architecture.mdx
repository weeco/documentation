...
[Tiered Storage](../../data-management/tiered-storage/) allows unlimited data retention and disaster recovery. With Tiered Storage enabled on your topics, you can retain the full history of events in cloud object storage. 
