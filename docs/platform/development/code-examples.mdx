...
supported, reach out to our team in the community
<a href="https://redpanda.com/slack">Slack</a>.
...
In this example you have developed the building blocks of a Redpanda client
...
The code provided in this example is intentionally simple to help you get
started. For more advanced examples, including how to build stream processing
applications that can aggregate, join, and filter your data streams, check out
the following links:
