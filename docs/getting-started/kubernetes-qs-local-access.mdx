---
title: Kubernetes with local access
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Kubernetes quickstart with local access

This guide will help you set up Redpanda locally for development and testing purposes on macOS, Windows, or Linux. Start here if you want to set up Redpanda quickly to try it out or for CI/CD purposes. If you want to use Amazon EKS or GKE, see the [Kubernetes quickstart for cloud](https://docs.redpanda.com/docs/getting-started/kubernetes-qs-cloud). If you want to use minikube, see the [Kubernetes quickstart with minikube](https://docs.redpanda.com/docs/getting-started/kubernetes-qs-minikube).
...
The command to set up a cluster requires you to have a `docs/kind-external.yaml` file that contains the following text: 
...
The Redpanda image contains the `rpk` and `redpanda` binaries. `rpk` is a CLI utility that you can use to work with your Redpanda nodes. See the [rpk commands](https://docs.redpanda.com/docs/reference/rpk-commands) documentation for a full list of commands. 
