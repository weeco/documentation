...
<head>
    ...
    <meta name="description" content="Configuring Protobuf deserialization to deocde encoded Kafka records in Redpanda Console."/>
</head>
...
[programmable push filters](/docs/console/features/programmable-push-filters) like a JavaScript object.
...
[Schema registry](/docs/console/features/schema-registry) for information about how to set up the schema registry in Redpanda Console.
