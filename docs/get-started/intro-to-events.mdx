...
- To get started with a self-hosted Redpanda platform deployment, see [Redpanda Licensing](../licenses).
- To get started with a Redpanda Cloud deployment, see [Dedicated Cloud vs BYOC](../../deploy/deployment-option/cloud/cloud-architecture/).
