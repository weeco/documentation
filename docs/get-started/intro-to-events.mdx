...
## Next steps
- To spin up a Redpanda cluster to try it out, see see [Redpanda Quickstart](../quick-start). 
...
- For information about a Redpanda Cloud deployment, see [Dedicated Cloud vs BYOC](../../deploy/deployment-option/cloud/dedicated-byoc/).
