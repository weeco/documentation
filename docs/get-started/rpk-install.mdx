...
You can install `rpk` as part of a bundle that includes `redpanda` (see the [Install Redpanda](../quick-start) for instructions), or you can install the `rpk` binary separately. 
