...
- [Introduction to rpk](../get-started/rpk-install)
    ...
    You can install `rpk` as part of a bundle that includes `redpanda` (see the [Redpanda Quickstart](../get-started/quick-start/quick-start-docker) for instructions), or you can install the `rpk` binary separately. 
