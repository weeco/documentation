...
<head>
    ...
    <meta name="description" content="Setup data archiving on Redpanda."/>
</head>
...
1. Create the cloud storage bucket and prepare it to be archived:
    ...
    - Google Cloud Storage
        - Choose a uniform access control when you create the bucket.
            ...
            - Set a [default project](https://cloud.google.com/storage/docs/core/migrating#defaultproj).
        - [Create a service user with Hash-based Message Authentication Code (HMAC) keys](https://cloud.google.com/storage/docs/core/authentication/managing-hmackeys)
...
2. Configure the following properties using (cluster configuration rpk commands)[/docs/core/cluster-administration/cluster-property-configuration]:
