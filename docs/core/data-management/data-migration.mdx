...
One of the more elegant aspects of Redpanda is that it is compatible with the [Kafka API and ecosystem](/docs/core/reference/faq).
...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](/docs/core/cloud/kubernetes/kubernetes-qs-cloud), [Docker](/docs/core/quickstart/quick-start-docker), [Linux](/docs/core/quickstart/quick-start-linux), or [MacOS](/docs/core/quickstart/quick-start-macos).
