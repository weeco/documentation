...
Refer to the [Okta guide](https://developer.okta.com/docs/core/guides/sign-into-web-app-redirect/-/main/) to create
...
login:
  ...
  # Random string which is used to sign JSON web tokens
  # It has to be static across all Console instances and restarts
  jwtSecret: ""
...
and their memberships using the Okta API. To create an API token, refer to the [Okta guide](https://developer.okta.com/docs/core/guides/create-an-api-token/main/).
