...
[programmable push filters](/docs/core/console/features/programmable-push-filters) like a JavaScript object.
...
[Schema registry](/docs/core/console/features/schema-registry) for information about how to set up the schema registry in Redpanda Console.
