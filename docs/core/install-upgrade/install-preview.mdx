...
curl -1sLf 'https://packages.vectorized.io/E4xN1tVe3Xy60GTx/redpanda-unstable/setup.deb.sh' | 
sudo -E bash && \
...
```bash
## Run the setup script to download and install the unstable repo
curl -1sLf 'https://packages.vectorized.io/E4xN1tVe3Xy60GTx/redpanda-unstable/setup.rpm.sh' | 
sudo -E bash && \
