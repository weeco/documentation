...
--version <VERSION>
```
For more information about installing Redpanda in Kubernetes, refer to our [getting started guide on Kubernetes](/docs/core/quickstart/kubernetes-qs-cloud/).
