...
You can use IAM roles with any Redpanda feature that makes use of cloud storage, such as [Tiered Storage](/docs/core/data-management/tiered-storage/) or [Remote Read Replicas](/docs/core/data-management/remote-read-replicas).
...
1. [Create a storage bucket](https://cloud.google.com/storage/docs/core/creating-buckets).
2. [Create an allow policy](https://cloud.google.com/iam/docs/core/overview), also called an IAM policy, that specifies the principal, the role, and the role binding.
