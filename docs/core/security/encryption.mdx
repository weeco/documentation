...
For Kubernetes-specific information, see [Redpanda Security on Kubernetes](/docs/core/security/security-kubernetes). 

## Prerequisite

TLS certificates are necessary for encryption. You can use your own certificates, either self-signed or issued by a trusted Certificate Authority, or you can use use the Redpanda [prepared script](https://gist.github.com/0x5d/56422a0c447e58d8ccbfa0ce1fd6bac6) to generate certificates:
...
See also: 
- [Configuring Listeners](/docs/core/cluster-administration/listener-configuration)
- [Configuring Redpanda TLS on Kubernetes](/docs/core/security/tls-kubernetes)
...
See also: 
- [Configuring Listeners](/docs/core/cluster-administration/listener-configuration)
- [Configuring mTLS with authentication](/docs/core/security/authentication)
- [Configuring Redpanda mTLS on Kubernetes](/docs/core/security/kubernetes-mtls)
...
See Also: [Configuring Listeners](/docs/core/cluster-administration/listener-configuration)
