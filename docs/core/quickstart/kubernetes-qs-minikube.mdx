...
* [minikube](https://minikube.sigs.k8s.io/docs/core/start/) version 1.25.1 or later
...
See the minikube [`delete`](https://minikube.sigs.k8s.io/docs/core/commands/delete/) documentation for more information. 
