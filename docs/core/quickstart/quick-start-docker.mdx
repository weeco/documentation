...
For production or benchmarking, setup a [production deployment](/docs/core/deployment/production-deployment).
...
:::note
 ...
 - You can also use [`rpk container`](/docs/core/deployment/guide-rpk-container) to run Redpanda in containers
...
Otherwise, just point your [Kafka-compatible client](/docs/core/reference/faq#what-clients-do-you-recommend-to-use-with-redpanda) to 127.0.0.1:9092.
...
- Our [FAQ](/docs/core/reference/faq) page shows all of the clients that you can use to do streaming with Redpanda.
    (Spoiler: Any Kafka-compatible client!)
- Get a multi-node cluster up and running using [`rpk container`](/docs/core/deployment/guide-rpk-container).
- Want to setup a production cluster? Check out our [Production Deployment Guide](/docs/core/deployment/production-deployment).
