...
For information about the latest metrics available on `:9644/public_metrics`, see [Monitoring](/docs/core/cluster-administration/monitoring).
...
* See rpk details in the [rpk command reference](/docs/core/reference/rpk-commands/#rpk-generate-prometheus-config). 
:::
...
See details in the [rpk command reference](/docs/core/reference/rpk-commands/#rpk-generate-grafana-dashboard). 
