...
| cloud_storage_enabled | Enable archival storage. _This property must be enabled in order to use [Tiered Storage](https://docs.redpanda.com/docs/data-management/tiered-storage/) or Remote Read Replicas._ <br/><br/>Default: false | Yes |
