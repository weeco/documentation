...
* Transactions
    * The Transactions API is available in technical preview, but it can be enabled by setting both `enable_idempotence` and `enable_transactions` to `true` in the Redpanda config. Supports KIP-345, KIP- 360, KIP-447, and others.
