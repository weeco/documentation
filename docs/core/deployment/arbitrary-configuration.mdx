...
<head>
    <meta name="title" content="Arbitrary configuration | Redpanda Docs"/>
    <meta name="description" content="Arbitrary configuration parameters for the Redpanda operator."/>
</head>

# Arbitrary configuration

Before continuing please go over the [Kubernetes Quick Start Guide](/docs/core/quickstart/kubernetes-qs-cloud/) and follow the steps for setting up the Redpanda Operator and optionally a Redpanda cluster.
...
However, Redpanda offers a broad range of custom properties for [node configuration](/docs/core/cluster-administration/node-property-configuration) besides cluster configuration.
