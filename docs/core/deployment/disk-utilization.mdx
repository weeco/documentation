...
* You can configure message retention and storage properties.
* You can create a ballast file to act as a buffer against an out-of-disk outage.
* You can monitor disk space metrics.  
* When free disk space reaches a critically low level, Redpanda blocks clients from producing. 

If you do run out of disk space, you can delete your ballast file, which gives you time to take action. Look at metrics for your topics, and adjust your retention properties to reduce the amount of disk space used. Or, add another disk to force a rebalance.
...
:::tip
Use [Continuous Data Balancing](/docs/core/cluster-administration/continuous-cluster-balancing) to automatically distribute partitions across nodes with enough disk space and avoid disks becoming full.
:::

## Log cleanup and message retention

Retention properties control how long messages are kept on disk before they're deleted or compacted. Setting message retention properties is the best way to keep messages as long as you need without running out of disk space. 
...
A ballast file is an empty file that takes up disk space. If Redpanda runs out of disk space and becomes unavailable, you can delete the ballast file, which clears up some space and gives you time to delete topics or records and change your retention properties. You can delete the ballast file as a last resort.
