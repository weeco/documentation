...
Retention policy controls how long messages are kept in on-disk logs before they're deleted or compacted. This is the main tool you can use to keep messages as long as you need, without running out of disk space. You can configure retention properties to delete messages based on the following:
...
Based on these properties, Redpanda automatically runs a log cleanup process in the background. 
