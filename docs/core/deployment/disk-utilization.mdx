...
* Use [Continuous Data Balancing](/docs/core/cluster-administration/continuous-cluster-balancing) to automatically distribute partitions across nodes for more balanced disk usage.
...
## Message retention and log cleanup
...
If you start to run out of disk space, adjust your retention properties to reduce the amount of disk space used. Based on these properties, Redpanda runs a log cleanup process in the background. 
