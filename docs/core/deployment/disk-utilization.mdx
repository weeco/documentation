...
* Use [Continuous Data Balancing](/docs/core/cluster-administration/continuous-data-balancing) to automatically distribute partitions across nodes for more balanced disk usage.
