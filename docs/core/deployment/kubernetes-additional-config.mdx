...
:::tip
Use one of the Redpanda Kubernetes quickstart guides to install the Redpanda operator and create a cluster in a few easy steps. We have quickstart guides for [cloud](/docs/core/cloud/kubernetes/kubernetes-qs-cloud), [kind](/docs/core/quickstart/kubernetes-qs-local-access), and [minikube](/docs/core/quickstart/kubernetes-qs-minikube).
:::
...
If you want to view whether a change to a property requires a restart, see [Cluster-level properties](/docs/core/reference/cluster-properties).
