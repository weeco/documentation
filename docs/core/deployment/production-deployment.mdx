...
[Docker](/docs/core/quickstart/quick-start-docker), or [Kubernetes](/docs/core/cloud/kubernetes/kubernetes-qs-cloud).

:::note
Before you set up your Redpanda cluster, refer to the [Performance and storage tuning](https://docs.redpanda.com/docs/core/deployment/performance-storage-tuning) documentation for guidelines on cluster creation, such as avoiding out-of-disk outages.
:::
