...
The [Kubernetes Quick Start guide](/docs/core/cloud/kubernetes/kubernetes-qs-cloud) describes how to quickly get up and running with a Kubernetes cluster.
...
- Check out our in-depth explanation of [Kubernetes connectivity](/docs/core/deployment/kubernetes-connectivity).
- Contact us in our <a href="https://redpanda.com/slack" target="_self">Slack</a> community so we can work together to implement your Kubernetes use cases.
