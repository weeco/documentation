...
<head>
    <meta name="title" content="Using Terraform and Ansible to deploy Redpanda | Redpanda Docs"/>
    <meta name="description" content="Using Terraform and Ansible to deploy Redpanda."/>
</head>

You can easily deploy Redpanda for production on [bare-metal with the Redpanda installation binary](/docs/core/deployment/production-deployment).
...
- With the [Redpanda installation binary](/docs/core/deployment/production-deployment)
- With Ansible

## Installing Redpanda with Ansible

Whether you are using [bare-metal servers](/docs/core/deployment/production-deployment) or Terraform, you can use Ansible to install Redpanda.
