...
<head>
    <meta name="title" content="Configuring Redpanda mTLS authentication on Kubernetes | Redpanda Docs"/>
    <meta name="description" content="Configuring Redpanda mTLS authentication on Kubernetes."/>
</head>
