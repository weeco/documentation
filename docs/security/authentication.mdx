...
- [Configuring Listeners](/docs/cluster-administration/listener-configuration)
- [Writing Custom Deployment Automation](/docs/deployment/custom-deployment)
...
HTTP Proxy has similar configuration, but the configuration node is `pandaproxy_client`:
...
The HTTP Proxy and Schema Registry will require valid client certificates.
