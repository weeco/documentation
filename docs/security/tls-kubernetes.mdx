...
This document provides details on how to enable TLS on Kubernetes. Alone, TLS authenticates the server and encrypts communication between the client and the server. To add client authentication, you can combine TLS encryption with SASL authentication or you can configure mTLS authentication.
