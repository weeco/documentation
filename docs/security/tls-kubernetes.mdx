...
The Redpanda GitHub repository contains a `tls.yaml` sample configuration file you can use to enable TLS: [redpanda-examples../../example-config/kubernetes/tls.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main../../example-config/kubernetes/tls.yaml).
...
For information about external connectivity, including subdomains, see [External connectivity](../../security/security-kubernetes#external-connectivity).
...
For information about how certificates are created and used in Redpanda, see [Certificates](../../security/security-kubernetes#certificates).
...
```bash
kubectl apply -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/tls.yaml
```
...
You can use [rpk commands](../../reference/rpk/rpk-topic) to start producing and consuming to your cluster.
