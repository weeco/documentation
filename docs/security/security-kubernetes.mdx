...
For details about providing a trusted issuer or certificate issuer, see [Configuring Redpanda TLS on Kubernetes](/docs/security/tls-kubernetes) and [Configuring Redpanda mTLS on Kubernetes](/docs/security/kubernetes-mtls). 
