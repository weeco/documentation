...
For Kubernetes-specific information, see [Redpanda Security on Kubernetes](../../security/security-kubernetes). 
...
- [Configuring Redpanda mTLS on Kubernetes](../../security/kubernetes-mtls)
