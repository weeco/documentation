...
You can use IAM roles with any Redpanda feature that makes use of cloud storage, such as [Tiered Storage](/docs/data-management/tiered-storage/) or [Remote Read Replicas](/docs/data-management/remote-read-replicas).
