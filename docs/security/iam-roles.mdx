...
You can use IAM roles with any Redpanda feature that makes use of cloud storage, such as [Tiered Storage](../../data-management/tiered-storage/) or [Remote Read Replicas](../../data-management/remote-read-replicas).
...
1. [Create a storage bucket](https://cloud.google.com/storage../../creating-buckets).
