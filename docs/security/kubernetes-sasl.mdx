...
Now that you have your superuser and additional users that can interact with the cluster, use the [rpk reference](/docs/reference/rpk/rpk-acl) documentation to experiment with the `rpk` commands and create additional users and ACLs.
