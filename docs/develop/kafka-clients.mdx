...
| Property | Redpanda default value | Kafka default value | Notes |
| :-- | :-- | :-- | :-- |
|[`auto_create_topics_enabled`](../../reference/cluster-properties#auto_create_topics_enabled)| `false` | `true` | Prevents errant applications from creating too many new topics. | 
|[`log_segment_ms`](../../reference/cluster-properties#log_segment_ms)| 14 days | 7 days | Sets the range of time within a segment that Redpanda can handle out-of-order timestamps. | 
