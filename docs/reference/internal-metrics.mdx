...
* See rpk details in the [rpk command reference](/docs/reference/rpk-commands/#rpk-generate-prometheus-config). 
:::
...
See details in the [rpk command reference](/docs/reference/rpk-commands/#rpk-generate-grafana-dashboard). 
