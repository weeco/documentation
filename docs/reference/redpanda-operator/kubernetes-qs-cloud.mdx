...
Alternatively, to create an Amazon EKS cluster for running Redpanda that is tuned by the [autotuner](../../rpk/rpk-redpanda/rpk-redpanda-tune), copy the following text and save it as `eks-bootstrap.yaml`: 
