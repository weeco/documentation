...
1. Create an Amazon EKS cluster:
    ...
    - To create a cluster that's isn't auto-tuned for running Redpanda, run the following:
    ...
    - To create a cluster that is auto-tuned for running Redpanda, do the following:
