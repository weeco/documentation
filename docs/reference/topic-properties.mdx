...
Many [cluster properties](../../manage/cluster-maintenance/cluster-property-configuration) have corresponding topic-level properties. The value of a cluster property applies for all topics of a cluster. To customize the value for a topic, you can set a topic-level property that overrides the value of the corresponding cluster property.
