...
<head>
  ...
  <meta
    name="description"
    content="Configure topic-level properties for Redpanda that override corresponding node or cluster properties."
  />
</head>
...
The following properties manage the disk space used by a topic:
