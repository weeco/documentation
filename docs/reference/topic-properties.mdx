...
## Topic property overrides cluster property

Many topic-level properties override the value of a corresponding cluster property. If a topic-level property isn't set, the corresponding cluster property takes effect by default.

| Topic property                                    | Overridden Cluster property                                                      |
| :------------------------------------------------ | :------------------------------------------------------------------------------- |
