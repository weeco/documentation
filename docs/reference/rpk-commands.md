...
By default, Redpanda runs in development mode. For [production deployments](/docs/deploy-self-hosted/production-deployment/), set the redpanda mode to `production`.
