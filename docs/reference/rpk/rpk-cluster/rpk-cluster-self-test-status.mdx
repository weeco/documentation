...
Use this command after invoking [rpk cluster self-test start](../../rpk-cluster/rpk-cluster-self-test-start) to determine the status of the jobs launched. Possible results are:
