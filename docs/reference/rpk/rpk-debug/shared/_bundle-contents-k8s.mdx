...
|`/logs`|Logs of each Pod in the the given Kubernetes namespace.<br/>If `--logs-since` is passed, only the logs within the given timeframe are included.<br/>**Requires ClusterRole**.|
