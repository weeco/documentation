...
Timeout used to detect idle state of the object storage API. If no API requests are made for at least this timeout's duration, the object storage is considered idle.
