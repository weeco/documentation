...
The maximum delay inserted in the data path of Kafka API requests to throttle them down. Ensures that responses to Kafka API calls will not be delayed beyond the timeout set by your Kafka client because of throttling.
