...
The maximum delay inserted in the data path of Kafka API requests to throttle them down. Enables a configurable request timeout so that it can be less than (fit within) the request timeout(s) of your Kafka client(s). 
