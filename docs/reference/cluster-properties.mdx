...
Default lifetime of log segments for topics which do not set `segment.ms`. It's an optional property; if `null`, the property is disabled.

**Units**: milliseconds

**Default**: null

**Range**: [60000 (60 sec), ...] or `null`
