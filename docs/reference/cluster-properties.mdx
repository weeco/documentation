...
Bit flags setting the default topic cleanup policy: compact and/or delete. It is overridden per topic by the topic property [`cleanup.policy`](../topic-properties#cleanuppolicy).
