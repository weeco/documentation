...
[Tunable properties](/docs/reference/cluster-properties) are also considered cluster properties. These properties are used for tuning the cluster. You should not need to change these default settings for normal operation.
...
For instructions on how to change node property settings, see [Configuring Node-level Properties](/docs/cluster-administration/node-property-configuration).
