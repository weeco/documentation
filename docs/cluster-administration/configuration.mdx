...
[Tunable properties](/docs/reference/tunable-properties) are also considered cluster properties. These properties are used for tuning the cluster. You should not need to change these default settings for normal operation.

For a full list of cluster properties, their descriptions, and their default values, see [Cluster configuration properties](/docs/reference/cluster-properties).

For instructions on how to change cluster property settings and how to export a configuration to another cluster, see [Configuring cluster properties](/docs/cluster-administration/cluster-property-configuration).
...
For a full list of node properties, their descriptions, and their default values, see [Node configuration properties](/docs/reference/node-properties).
For instructions on how to change node property settings, see [Configuring node properties](/docs/cluster-administration/node-property-configuration).
