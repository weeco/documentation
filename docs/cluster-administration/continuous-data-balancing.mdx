...
:::important
This feature requires an [Enterprise license](/docs/introduction/licensing). To upgrade, contact [Redpanda sales](https://redpanda.com/try-redpanda?section=enterprise-cloud).
:::
...
For information about other modes with `partition_autobalancing_mode`, see [Cluster Balancing](/docs/cluster-administration/cluster-balancing).
