...
With an Enterprise license, you can additionally enable *Continuous Data Balancing* to continuously monitor node availability and disk usage. This enables self-healing clusters that dynamically balance partitions. See [Continuous Data Balancing](/docs/cluster-administration/continuous-data-balancing).
