...
After the node is in maintenance mode, it is safe to take it offline and perform any required software or hardware updates on it. 
...
- You must be running  Redpanda version 22.1 or later. 
