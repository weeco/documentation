...
[the manual installation section](/docs/deployment/production-deployment#manual-installation)
...
[monitoring docs](/docs/cluster-administration/monitoring)
...
[Quick Start Linux Guide](/docs/quickstart/quick-start-linux)
...
If you are [Setting up a 3-node cluster](./docs/quickstart/quick-start-docker#Set-up-a-3-node-cluster) and create a topic with two replicas like the following, then the following command would fail.
