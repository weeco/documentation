...
[the manual installation section](../deployment/production-deployment#manual-installation)
...
[Quick Start Linux Guide](../quickstart/quick-start-linux)
...
If you are [Setting up a 3-node cluster](../quickstart/quick-start-docker#set-up-a-3-node-cluster) and create a topic with two replicas like the following, then the following command would fail.
