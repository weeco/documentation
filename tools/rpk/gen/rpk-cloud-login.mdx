...
- In $HOME/.config/rpk/\_\_cloud.yaml, in 'client_id' and 'client_secret' fields
...
client secret and will save them to the **cloud.yaml file. If you specify
environment variables or flags, they will not be synced to the **cloud.yaml
