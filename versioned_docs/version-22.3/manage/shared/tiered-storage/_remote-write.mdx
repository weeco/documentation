...
:::note
Starting in version 22.3, when you delete a topic in Redpanda, the data is also deleted in cloud storage. See [Enable Tiered Storage for a topic](#enable-tiered-storage-for-topics).
:::