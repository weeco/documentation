...
- [Self-Hosted](../deployment-option/self-hosted)
  - [Kubernetes](../deployment-option/self-hosted/kubernetes)
    - [Kubernetes Cluster Requirements](../deployment-option/self-hosted/kubernetes/kubernetes-cluster-requirements)
    ...
    - [Kubernetes Production Deployment](../deployment-option/self-hosted/kubernetes/kubernetes-production-deployment)
    ...
    - [Best Practices](../deployment-option/self-hosted/kubernetes/kubernetes-best-practices)

        This topic explains Redpanda's tips and recommendations for Kubernetes deployments.

    - [Tune Worker Nodes](../deployment-option/self-hosted/kubernetes/kubernetes-tune-workers)
    ...
    - [Deploy Redpanda](../deployment-option/self-hosted/kubernetes/kubernetes-deploy)
