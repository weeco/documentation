...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        returns exact name matches of either prefixed or literal pattern type.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        returns wildcard matches, prefix patterns that match your input, and
        literal matches.
      </td>
    </tr>
    <tr>
      ...
      <td>
        returns prefix patterns that match your input (prefix <code>fo</code>{" "}
        matches
        <code>foo</code>).
      </td>
    </tr>
    <tr>
      ...
      <td>returns exact name matches.</td>
    </tr>
  </tbody>
</table>
