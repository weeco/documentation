...
| ![](https://img.shields.io/badge/-Deprecated-red.svg) enable_auto_rebalance_on_node_add | Enable automatic partition rebalancing when new nodes are added. <br/><br/>Default: false | No |
