...
This page provides details about how Redpanda works. For a high-level overview, see [Introduction to Redpanda](../../introduction/intro-to-events).
...
[Try out Redpanda](../../quickstart/), or learn about [Redpanda Licensing](../../introduction/licenses). 
