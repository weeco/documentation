...
One of the more elegant aspects of Redpanda is that it is compatible with the [Kafka API and ecosystem](../../reference/faq).
...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](../../quickstart/kubernetes-qs-cloud/), [Docker](../../quickstart/quick-start-docker), [Linux](../../quickstart/quick-start-linux), or [MacOS](../../quickstart/quick-start-macos).
...
If you run into any difficulty with data migration, contact us in our [Slack](https://redpanda.com/slack) community so we can help you succeed.
