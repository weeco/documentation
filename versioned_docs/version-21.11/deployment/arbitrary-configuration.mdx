...
Before continuing please go over the [Kubernetes Quick Start Guide](/docs/quickstart/kubernetes-qs-dev/) and follow the steps for setting up the Redpanda Operator and optionally a Redpanda cluster.
