...
The [Kubernetes Quick Start Guide](/docs/core/quickstart/kubernetes-qs-cloud/) walks you through the steps to set up the Redpanda operator and a Redpanda cluster.
