...
The [Kubernetes Quick Start guide](/docs/quickstart/kubernetes-qs-cloud/) describes how to quickly get up and running with a Kubernetes cluster.
...
<Tabs>
  ...
  First complete the "Before You Begin" steps described in [Google Kubernetes Engine Quickstart](https://kubernetes.io/docs/contribute/generate-ref-docs/quickstart/).
...
- Check out our in-depth explanation of [Kubernetes connectivity](/docs/deployment/kubernetes-connectivity).
