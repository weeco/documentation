...
[redpanda-examples../../example-config/kubernetes/tls.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main../../example-config/kubernetes/tls.yaml)
...
```bash
kubectl delete -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/tls.yaml stegosaurus_config.yaml stegosaurus_pod.yaml
```
