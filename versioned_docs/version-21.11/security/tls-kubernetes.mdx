...
* [Kubernetes quickstart for cloud](/docs/quickstart/kubernetes-qs-dev/)
* [Kubernetes quickstart with local access on kind](/docs/quickstart/kubernetes-qs-dev)
* [Kubernetes quickstart with local access on minikube](/docs/quickstart/kubernetes-qs-dev)
...
You can use the <a href="https://docs.redpanda.com/docs/21.11/reference/rpk-commands" target="_self">rpk commands</a> documentation to start producing and consuming to your cluster.
...
Use the <a href="https://docs.redpanda.com/docs/21.11/reference/rpk-commands" target="_self">rpk commands</a> documentation to experiment with producing and consuming to your cluster. When you're ready, delete the cluster and configuration files with this command:
