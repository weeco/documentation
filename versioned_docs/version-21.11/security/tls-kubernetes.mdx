...
The Redpanda GitHub repository contains a `tls.yaml` [sample configuration file](https://github.com/redpanda-data/redpanda-examples/blob/main/docs/example-config/kubernetes/tls.yaml) you can use to enable TLS.
