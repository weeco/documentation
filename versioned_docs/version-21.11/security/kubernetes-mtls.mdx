...
[redpanda-examples../../example-config/kubernetes/mtls.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main../../example-config/kubernetes/mtls.yaml)
...
```bash
kubectl apply -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/mtls.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/mtls.yaml triceratops_config.yaml triceratops_pod.yaml
```
