...
[redpanda-examples/docs/core/example-config/kubernetes/mtls.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main/docs/core/example-config/kubernetes/mtls.yaml)
...
```bash
kubectl apply -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main/docs/core/example-config/kubernetes/mtls.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main/docs/core/example-config/kubernetes/mtls.yaml triceratops_config.yaml triceratops_pod.yaml
```
