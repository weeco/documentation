...
* [Kubernetes quickstart for cloud](/docs/core/quickstart/kubernetes-qs-cloud/)
...
You can provide a certificate as a Secret by adding the `nodeSecretRef` property to the cluster specification file that you created above. For information about Secrets, see the Kubernetes [Secrets](https://kubernetes.io/docs/concepts/configuration/secret/) documentation. The cert-manager [Certificate](https://cert-manager.io/docs/core/concepts/certificate/) documentation contains detailed information about certificates, including a diagram of the certificate lifecycle.
