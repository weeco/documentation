...
The [Kubernetes Quick Start guide](/docs/core/quickstart/kubernetes-qs-cloud/) describes how to quickly get up and running with a Kubernetes cluster.
...
<Tabs>
  ...
  First complete the "Before You Begin" steps described in [Google Kubernetes Engine Quickstart](https://cloud.google.com/kubernetes-engine/docsquickstart).
