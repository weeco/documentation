...
Before continuing please go over the [Kubernetes Quick Start Guide](/docs/core/cloud/kubernetes/kubernetes-qs-cloud) and follow the steps for setting up the Redpanda Operator and optionally a Redpanda cluster.
...
Cluster. However, Redpanda offers a broad range of parameters ([Custom configuration](/docs/core/cluster-administration/configuration)) not all of which are included in the Cluster definition.
