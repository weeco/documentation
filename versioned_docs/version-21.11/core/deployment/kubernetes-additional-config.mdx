...
The [Kubernetes Quick Start Guide](/docs/core/cloud/kubernetes/kubernetes-qs-cloud) walks you through the steps to set up the Redpanda operator and a Redpanda cluster.

In addition to the basic cluster specifications, you can add other parameters that are typically defined in the Redpanda [configuration file](/docs/core/cluster-administration/configuration).
