...
- You can also set up a [Kubernetes cluster with external access](../../deployment/kubernetes-external-connect).
...
You can find more information about the command as well as tuning recommendations in the [Set Redpanda production mode](../../deployment/production-deployment#step-2-set-redpanda-production-mode) documentation. 
...
- Check out our in-depth explanation of how to [connect external clients](../../deployment/kubernetes-connectivity) to a Redpanda Kubernetes deployment.
- Contact us in our [Slack](https://redpanda.com/slack) community so we can work together to implement your Kubernetes use cases.