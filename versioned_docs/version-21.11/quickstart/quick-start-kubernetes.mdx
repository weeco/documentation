...
- For production or benchmarking, set up a [production deployment](/docs/deployment/production-deployment).
- You can also set up a [Kubernetes cluster with external access](/docs/deployment/kubernetes-external-connect).
...
You can find more information about the command as well as tuning recommendations in the [Set Redpanda production mode](/docs/deployment/production-deployment#step-2-set-redpanda-production-mode) documentation. 
...
- Check out our in-depth explanation of how to [connect external clients](/docs/deployment/kubernetes-connectivity) to a Redpanda Kubernetes deployment.
