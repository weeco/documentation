...
`rpk` is essentially a CLI tool that you can use to run [management and data commands](/docs/21.11/reference/rpk-commands) on the cluster.
...
- Our [FAQ](/docs/development/kafka-clients) page shows all of the clients that you can use to do streaming with Redpanda.
    (Spoiler: Any Kafka-compatible client!)
- Get a multi-node cluster up and running using [`rpk container`](/docs/deployment/guide-rpk-container).
- Use the [Quick Start Docker Guide](/docs/quickstart/quick-start-docker) to try out Redpanda using Docker.
- Want to setup a production cluster? Check out our [Production Deployment Guide](/docs/deployment/production-deployment).
