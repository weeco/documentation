...
For production or benchmarking, setup a [production deployment](/docs/deployment/production-deployment).
...
:::note
 ...
 - You can also use [`rpk container`](/docs/deployment/guide-rpk-container) to run Redpanda in containers
...
Otherwise, just point your [Kafka-compatible client](/docs/development/kafka-clients) to 127.0.0.1:9092.
