...
One of the more elegant aspects of Redpanda is that it is compatible with the [Kafka API and ecosystem](/docs/development/kafka-clients).
...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](/docs/quickstart/kubernetes-qs-dev), [Docker](/docs/quickstart/quick-start-docker), [Linux](/docs/quickstart/quick-start-linux), or [MacOS](/docs/quickstart/quick-start-macos).
