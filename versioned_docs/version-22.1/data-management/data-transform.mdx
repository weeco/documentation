...
This feature is in technical preview and is not supported for production. For more information about technical previews, see [Technical Preview](../../introduction/tech-preview).
...
Redpanda allows you to deploy custom Node.js programs to handle the entire consume-transform-produce cycle for you. This is handled by a transformation engine built on top of [Wasm](https://developer.mozilla.org/en-US../../WebAssembly) technology.
...
You can also refer to [rpk's reference page](/docs/22.1/reference/rpk-commands/) for further commands.
