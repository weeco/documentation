...
[redpanda-examples../../example-config/kubernetes/sasl.yaml](https://github.com/redpanda-data/redpanda-examples/blob/main../../example-config/kubernetes/sasl.yaml)
...
[redpanda-examples../../example-config/kubernetes](https://github.com/redpanda-data/redpanda-examples/tree/main../../example-config/kubernetes)
:::
...
```bash
kubectl apply -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/sasl.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/redpanda-data/redpanda-examples/main../../example-config/kubernetes/sasl.yaml
