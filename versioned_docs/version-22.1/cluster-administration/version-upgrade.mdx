...
:::info
Before upgrading to alternate versions, refer to the [release notes](https://github.com/redpanda-data/redpanda/releases) to learn about any breaking changes.
:::
