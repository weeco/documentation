...
:::tip
Use one of the Redpanda Kubernetes quickstart guides to install the Redpanda operator and create a cluster in a few easy steps. We have quickstart guides for [cloud](/docs/quickstart/kubernetes-qs-dev), [kind](/docs/quickstart/kubernetes-qs-dev), and [minikube](/docs/quickstart/kubernetes-qs-dev).
:::
