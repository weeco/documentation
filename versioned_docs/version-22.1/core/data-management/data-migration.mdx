...
- 2 Redpanda clusters - You can set up these clusters in any deployment you like, including [Kubernetes](/docs/core/quickstart/kubernetes-qs-cloud), [Docker](/docs/core/quickstart/quick-start-docker), [Linux](/docs/core/quickstart/quick-start-linux), or [MacOS](/docs/core/quickstart/quick-start-macos).
