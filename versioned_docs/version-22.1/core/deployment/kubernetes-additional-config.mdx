...
:::tip
Use one of the Redpanda Kubernetes quickstart guides to install the Redpanda operator and create a cluster in a few easy steps. We have quickstart guides for [cloud](/docs/core/quickstart/kubernetes-qs-cloud), [kind](/docs/core/quickstart/kubernetes-qs-local-access), and [minikube](/docs/core/quickstart/kubernetes-qs-minikube).
:::
