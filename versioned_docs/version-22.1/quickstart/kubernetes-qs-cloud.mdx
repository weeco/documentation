...
Complete the Before You Begin steps in the [Google Kubernetes Engine Quickstart](https://cloud.google.com/kubernetes-engine../../quickstart). Then create a cluster with this command:
...
```
See the GKE [Deleting a cluster](https://cloud.google.com/kubernetes-engine../../how-to/deleting-a-cluster) documentation for more information.
