...
Redpanda supports downloading tailored Grafana dashboards from [redpanda-data/observability](https://github.com/redpanda-data/observability) with `rpk generate grafana-dashboard`.
...
```
rpk generate grafana-dashboard > <output-file>
```

For details about the command and the available dashboards, refer to the [rpk generate grafana-dashboard](../../reference/rpk/rpk-generate/rpk-generate-grafana-dashboard) reference.
